...
const mySkills = [
  {
    ...
    color:
      "brightness(0) saturate(100%) invert(85%) sepia(92%) saturate(5503%) hue-rotate(339deg) brightness(101%) contrast(94%)",
  },
  {
    id: 2,
    name: "HTML5",
    ...
    color:
      "brightness(0) saturate(100%) invert(40%) sepia(91%) saturate(3148%) hue-rotate(350deg) brightness(94%) contrast(88%)",
  },
  {
    id: 3,
    name: "CSS3",
    ...
    color:
      "brightness(0) saturate(100%) invert(30%) sepia(53%) saturate(4114%) hue-rotate(189deg) brightness(86%) contrast(83%)",
  },

  {
    ...
    color:
      "brightness(0) saturate(100%) invert(84%) sepia(9%) saturate(5802%) hue-rotate(164deg) brightness(103%) contrast(97%)",
  },
  {
    id: 5,
    name: "Gatsby",
    ...
    color:
      "brightness(0) saturate(100%) invert(21%) sepia(20%) saturate(7282%) hue-rotate(256deg) brightness(89%) contrast(87%)",
  },
  {
    id: 10,
    name: "NodeJS",
    ...
    color:
      "brightness(0) saturate(100%) invert(57%) sepia(11%) saturate(3178%) hue-rotate(71deg) brightness(82%) contrast(78%)",
  },
  {
    id: 11,
    name: "Express",
    ...
    color:
      "brightness(0) saturate(100%) invert(100%) sepia(100%) saturate(2%) hue-rotate(284deg) brightness(109%) contrast(101%)",
  },
  {
    id: 12,
    name: "PostgreSQL",
    ...
    color:
      "brightness(0) saturate(100%) invert(35%) sepia(16%) saturate(1807%) hue-rotate(165deg) brightness(96%) contrast(87%)",
  },
  {
    id: 7,
    name: "Sass",
    ...
    color:
      "brightness(0) saturate(100%) invert(68%) sepia(24%) saturate(1937%) hue-rotate(291deg) brightness(83%) contrast(90%)",
  },
  {
    id: 13,
    name: "Postman",
    ...
    color:
      "brightness(0) saturate(100%) invert(61%) sepia(48%) saturate(5075%) hue-rotate(337deg) brightness(105%) contrast(105%)",
  },
  {
    id: 14,
    name: "Git",
    ...
    color:
      "brightness(0) saturate(100%) invert(42%) sepia(51%) saturate(4130%) hue-rotate(343deg) brightness(98%) contrast(92%)",
  },
  {
    id: 15,
    name: "Github",
    ...
    color:
      "brightness(0) saturate(100%) invert(33%) sepia(17%) saturate(5651%) hue-rotate(239deg) brightness(85%) contrast(94%)",
  },
  {
    id: 18,
    name: "Heroku",
    ...
    color:
      "brightness(0) saturate(100%) invert(15%) sepia(52%) saturate(5180%) hue-rotate(265deg) brightness(78%) contrast(140%)",
  },
  {
    id: 19,
    name: "Figma",
    ...
    color:
      "brightness(0) saturate(100%) invert(57%) sepia(73%) saturate(6457%) hue-rotate(351deg) brightness(98%) contrast(93%)",
  },
  {
    id: 6,
    name: "Redux",
    ...
    color:
      "brightness(0) saturate(100%) invert(29%) sepia(59%) saturate(1613%) hue-rotate(239deg) brightness(92%) contrast(85%)",
  },
  {
    id: 8,
    name: "React Router",
    ...
    color:
      "brightness(0) saturate(100%) invert(32%) sepia(35%) saturate(1520%) hue-rotate(315deg) brightness(105%) contrast(100%",
  },
];
const hardArr = [
  "React-Context",
...
function Skills(props) {
  ...
  const mySkills = [
    {
      ...
      color:
        "brightness(0) saturate(100%) invert(91%) sepia(49%) saturate(4100%) hue-rotate(339deg) brightness(101%) contrast(94%)",
    },
    {
      id: 2,
      name: "HTML5",
  ...
  return (
    <div name="skills" id="skills" className={skillStyles.skillsView}>
      ...
      <span className={skillStyles.rightBox}>
        <h1>And more...</h1>
        <a
